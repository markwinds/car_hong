...
*/
#define DCLOW()     gpio_set(PTA5 ,0);
#define DCHIGH()    gpio_set(PTA5 ,1);
#define CLKLOW()    gpio_set(PTA12 ,0);
#define CLKHIGH()   gpio_set(PTA12 ,1);
#define MISOLOW()   gpio_set(PTA6 ,0);
#define MISOHIGH()  gpio_set(PTA6 ,1);
#define RESLOW()    gpio_set(PTA7 ,0);
#define RESHIGH()   gpio_set(PTA7 ,1);
//
