...
qianzhan=User_parameter[2];
long_speed=User_parameter[3];
yuzhi=User_parameter[4];
yunsu_flag=User_parameter[5];
}
void DSYJ_canshugengxin()//按键返回
{
User_parameter[0]=dawan_speed;
User_parameter[1]=kp;
User_parameter[2]=qianzhan;
User_parameter[3]=long_speed;
User_parameter[4]=yuzhi;
User_parameter[5]=yunsu_flag;
}
...
LCD_6x8StrtoBMPL(1*16,5*8,"zhidaosudu:",1);
LCD_6x8StrtoBMPL(1*16,6*8,"yuzhi:",1);
 ...
 //+++++++++++++++++++++++++++++++++++++++++++++++++最后这里要改++++++++++++++++++++++++++++++++++       
  ...
  case 1:
        kp=Parameterset(kp);     
         break;
  case 2:
    qianzhan=Parameterset(qianzhan);     
         break;
  case 3:
    long_speed=Parameterset(long_speed);     
         break;
 
  case 4:
    yuzhi=Parameterset(yuzhi);     
          
         break;
  case 5:
    yunsu_flag=Parameterset(yunsu_flag);     
...
countprint(qianzhan,user_p2);
countprint(long_speed,user_p3); 
countprint(yuzhi,user_p4);
countprint(yunsu_flag,user_p5); 
